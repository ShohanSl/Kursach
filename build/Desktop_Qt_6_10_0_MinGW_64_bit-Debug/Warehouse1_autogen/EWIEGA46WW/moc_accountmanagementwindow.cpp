...
namespace {
struct qt_meta_tag_ZN23AccountManagementWindowE_t {};
} // unnamed namespace

template <> constexpr inline auto AccountManagementWindow::qt_create_metaobjectdata<qt_meta_tag_ZN23AccountManagementWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AccountManagementWindow, qt_meta_tag_ZN23AccountManagementWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AccountManagementWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23AccountManagementWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23AccountManagementWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN23AccountManagementWindowE_t>.metaTypes,
    nullptr
} };

void AccountManagementWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<AccountManagementWindow *>(_o);
...
void *AccountManagementWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23AccountManagementWindowE_t>.strings))
